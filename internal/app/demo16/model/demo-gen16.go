...
type DemoGen16InfoRes struct {
	gmeta.Meta   `orm:"table:demo_gen16"`
	Id           uint                           `orm:"id,primary" json:"id"` // ID
	Type         string                         `orm:"type" json:"type"`     // 姓名
	LinkedType   *LinkedDemoGen16DemoGenClass16 `orm:"with:id=type" json:"linkedType"`
	Subject      string                         `orm:"subject" json:"subject"`
	Group        string                         `orm:"group" json:"group"`
	LinkedGroup  *LinkedDemoGen16DemoGenClass16 `orm:"with:id=group" json:"linkedGroup"`
